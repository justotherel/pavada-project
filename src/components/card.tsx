...
export default function Card(props: CardProps) {
  const card = (
    <div className=" border-auxilary border-4 rounded-lg shadow-md shawod-black aspect-[1/1.5] hover:transition-transform hover:scale-110 min-h-[90px] xl:min-h-[150px]">
